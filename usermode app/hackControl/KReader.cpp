...
public:
	...
	{
		m_hDriver = CreateFileA("\\\\.\\tencentOverwatch", GENERIC_READ | GENERIC_WRITE, FILE_SHARE_READ | FILE_SHARE_WRITE, 0, OPEN_EXISTING, 0, 0);
		if (!m_hDriver)
		{
	...
	*/
	...
	void writeMem(ULONG WriteAddress, ULONG WriteValue, SIZE_T WriteSize, const PROTO_MESSAGE& w_protoMsg) const
	{
