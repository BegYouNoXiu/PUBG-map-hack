...
public:
	...
	inline float calcDistance(Vector3 v)
	{
...
namespace global
{
	...
	extern DWORD_PTR pULevel;
	extern DWORD_PTR pGameInstance;
	extern DWORD_PTR pULocalPlayer;
	extern DWORD_PTR pLocalPlayer_Controller;
	extern DWORD_PTR pLocalPlayer_entity;
	extern DWORD_PTR pLocalPlayer;
	extern DWORD_PTR pActorArray;
	extern DWORD_PTR ActorArray;
...
extern int pickup[10];
extern int buggy[6];
extern int van[3];
extern int boat[2];
extern int itemtype[2];
extern int airDrop[3];

extern  KReader  * m_KReader;
//extern static CURLWrapper* m_Curl;

//static KReader  *m_KReader = nullptr;
static CURLWrapper* m_Curl = nullptr;
